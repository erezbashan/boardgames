...
const oldRenderLogMessage = code.substring(
  code.indexOf('const renderLogMessage = (msg: string'),
  code.indexOf('const renderPlayerDetails')
);

const newRenderLogMessage = \`const renderLogMessage = (msg: string, defaultRenderer: (m: string) => React.ReactNode) => {
...
code = code.replace(oldRenderLogMessage, newRenderLogMessage);
